...
##################################################################
# Generated from reading file 'test_origin.json'
...
class TestOrigin(toga.MainWindow):
    def __init__(self, *args, **kwargs):
        kwargs.update(title = "toga view", position = toga.Position(x = 200, y = 200), size = toga.Size(width = 500, height = 300), resizable = False)
